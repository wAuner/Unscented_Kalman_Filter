...
void UKF::AugmentState() {
  // augmentation is needed due to non-linear transform function
  // (gaussians change if transformed non-linearly)
...
// based on the sigma points which have been mapped to k+1 using the motion model
